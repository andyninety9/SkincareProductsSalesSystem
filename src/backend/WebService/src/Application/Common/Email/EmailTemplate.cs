...
namespace Application.Common.Email
{
    ...
    {
        public static string GenerateNewUserCreatedByManagerHtml(string username, string verifyToken, string defaultPassword, string baseUrl)
        {
            ...
            <body>
                <div class='email-container'>
                    ...
                    <div class='content'>
                        ...
                        <p>An account has been created for you by your system manager. Here are your login credentials:</p>
                    ...
                    <div class='footer'>
                        ...
                        <p>If you did not expect this account creation, please contact your system administrator.</p>
                    </div>
                </div>
            </body>
            </html>";
    ...
    <body>
        ...
        {
            string verifyLink = $"{baseUrl}?verifyToken={verifyToken}";
            string emailHtml = $@"
    <!DOCTYPE html>
    <html lang='en'>
    <head>
