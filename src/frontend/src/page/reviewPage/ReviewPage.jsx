...
const reviews = [
    ...
    },
    {
        ...
        content: "I’ve been using this cream for two weeks now, and the texture is so smooth. It absorbs quickly without feeling greasy and keeps my skin hydrated throughout the day. Highly recommend for anyone with dry skin.",
    },
    {
        ...
        content: "I like the product but it’s a little too thick for my skin type. I have combination skin, and this cream doesn't absorb as easily in some areas, making it feel a bit sticky. Still, it does a good job moisturizing.",
    },
    {
        ...
        content: "The fragrance of this cream is amazing, and it works well on my skin. It leaves my face feeling soft and smooth. I just wish it wasn’t so heavily scented, but otherwise, I’m very happy with the product.",
    },
    {
        title: "Best cream ever",
        date: "15/01/2025",
...
export default function ReviewPage() {
    ...
    const handleScroll = () => {
        if (window.scrollY > 200) { // Cài đặt khoảng cách cuộn để hiển thị nút
                    ...
                    <div style={{ marginTop: "50px" }}>
                        <div style={{ marginBottom: "4%" }}>
                            ...
                            <div style={{ display: "flex", justifyContent: "center" }}>
                                <button style={{ backgroundColor: "#A76A6E", color: "white", padding: "10px 20px", borderRadius: "5px", border: "none", cursor: "pointer", fontSize: "15px" }}>
                                    Viết đánh giá
                                </button>
                            </div>
                        </div>
