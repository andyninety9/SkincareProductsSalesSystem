  ...
  return (
    <header style={{ width: "100%", borderBottom: "1px solid #ddd", backgroundColor: "white", boxShadow: "0px 2px 4px rgba(0,0,0,0.1)" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "16px" }}>
        {/* Logo */}
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "flex", alignItems: "center", padding: "16px" }}>
  <div style={{ flex: 1, display: "flex", justifyContent: "center" }}>
    <h1 style={{ fontSize: "24px", fontWeight: "600", textAlign: "center" }}>Mavid</h1>
  </div>
  <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
    <a href="#" style={{ fontSize: "18px", textDecoration: "none", color: "black", transition: "color 0.3s" }}>Đăng nhập</a>
